...
public class EmployeeServiceImplTest {
    ...
    public void testGetEmployeeByFirstname() {
        ...
        EmployeeEntity employeeRepo = employeeService.getEmployeeByFirstname("Captain").get(0);
    ...
    public void testGetEmployeeByLastname() {
        ...
        EmployeeEntity employeeRepo = employeeService.getEmployeeByLastname("America").get(0);
    ...
    public void testGetEmployees() {
        ...
        EmployeeEntity employeeRepo = employeeService.getEmployees().get(0);
